  ...
  return (
    <>
      ...
      <Container>
        {/* {component === 0 && (
          <Coc>
            ...
            <div className="right_coc">
              <div className="title_coc">Skills You Have</div>
        ...
        {component === 1 && (
          <Don>
            <div className="title_don">Do You Represent an Party...?</div>
        ...
        {component === 2 && (
          <Wsta>
            <div className="desc_wsta">
              Okey..! Then please let us know about yourself
            </div>
            <div className="text_button_wsta">
              ...
              <div className="buttons_wsta">
                ...
                <button className="done_wsta" onClick={() => setcomponent(6)}>
                  Next
                </button>
              </div>
            </div>
          ...
          <Cs>
            ...
            <div className="links_cs">
              <div className="git_cs">
                <div className="title_git_cs">Youtube </div>
                <input
                  type="text"
              ...
              <div className="linkd_cs">
                <div className="title_linked_cs">Instagram</div>
                <input
                  type="text"
                  placeholder="  paste here"
        ...
        {component === 4 && (
          <Edu>
            <div className="title_edu">Ok Then Submit Your Details</div>
              
            <div className="buttons_edu">
              <button className="submit_edu" onClick={() => setcomponent(6)}>
                Back
              </button>
              {btnloader ? (
                <CircularProgress />
        ...
        {component === 5 && (
          <Devy>
            ...
            <div className="title_devy">Select Your Party</div>
            ...
            <div className="buttons_devy">
              ...
              <button className="next_devy" onClick={() => setcomponent(6)}>
                Next
              </button>
            </div>
        ...
        {component === 6 && (
          <EducationDetails
            ...
            setcollege_name={setcollege_name}
            branch={branch}
            setbranch={setbranch}
            year={year}
            setyear={setyear}
